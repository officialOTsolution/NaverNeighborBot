...
"border-radius: 100px;")
        ...
        self.StartBtn.setStyleSheet("background-color: \n"
"#ff0000;border: 2px solid red;")
        ...
        self.HowToUse.setGeometry(QtCore.QRect(241, 397, 151, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.InstaLInk.setGeometry(QtCore.QRect(81, 397, 141, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_3.setGeometry(QtCore.QRect(230, 447, 162, 16))
...
"#ff0000;border: 2px solid red;")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(_translate("Dialog", "아이디 비밀번호 찾기"))
